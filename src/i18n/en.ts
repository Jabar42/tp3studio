...
const en: typeof es = {
  ...
  whatIsTp3: {
    ...
    pillars: [
      ...
      {
        icon: '🤖',
        title: 'With a built-in salesperson.',
        subtitle: 'AI that closes deals.',
        desc: 'Your agent chats with every visitor 24/7, answers questions, qualifies leads, schedules appointments, and processes payments. Like having your best salesperson on the page — no salary, no days off.',
      },
      {
        icon: '💬',
    ...
    vsRight: {
      ...
      items: [
        'A single page. The one that sells. Scroll = buying decision.',
  ...
  chatToAdmin: {
    ...
    subtitle: 'Manage your catalog, check metrics, publish content, see how your agent responds — all by chatting. Like having an employee who understands your business and never sleeps.',
    ...
    withChats: [
      ...
      },
      {
        ...
        agent: 'Done. Product published in the store and in the WhatsApp catalog. Anything else?',
      },
      {
        user: 'How is the agent handling shipping questions?',
    ...
    plans: [
      {
        ...
        desc: 'Your digital presence operated by artificial intelligence.',
        price: '$49',
        period: 'USD / month',
        monthly: '≈ 150,000 COP',
        features: [
          'AI-operated website (pure HTML, ultra-fast)',
          '24/7 AI agent that chats with customers',
          'Manage by chatting (no dashboard needed)',
          'Test how your agent responds anytime',
      ...
      },
      {
        tier: 'Most Popular',
        name: 'Business + Sales',
        desc: 'Everything in Start plus full e-commerce and a fully programmable agent.',
        price: '$99',
        period: 'USD / month',
        monthly: '≈ 300,000 COP',
        features: [
      ...
      {
        tier: 'Scale',
        name: 'Business + Multi-channel',
        desc: 'For businesses that need advanced administration and multiple channels.',
        price: '$199',
        period: 'USD / month',
        monthly: '≈ 600,000 COP',
        features: [
