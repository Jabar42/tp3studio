    ...
    plans: [
      {
        tier: 'Basic',
        name: 'Web Presence',
        desc: 'Professional landing page with contact form, WhatsApp, and social media.',
        price: '$200,000',
        period: 'COP / month',
        monthly: '≈ $48 USD',
        features: [
          ...
          'Email support — we respond within 48 business hours',
          'Setup in 3-5 days',
        ],
      ...
      },
      {
        ...
        features: [
          ...
          'Chat + email support — we respond within 24 business hours',
          'Setup in 5-7 days',
        ],
        hosting: 'Hosting + domain included',
